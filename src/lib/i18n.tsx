...
const bn: Dict = {
  ...
  'login.adminHint': 'অ্যাডমিন (রাসেল): admin@dhansiri.com / admin123',
  'login.caretakerHint': 'কেয়ারটেকার: caretaker@dhansiri.com / caretaker123',
...
const en: Dict = {
  ...
  'login.demo': 'Demo Logins',
  'login.adminHint': 'Admin (Rasel): admin@dhansiri.com / admin123',
  'login.caretakerHint': 'Caretaker: caretaker@dhansiri.com / caretaker123',
