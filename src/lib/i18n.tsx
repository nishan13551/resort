...
const bn: Dict = {
  ...
  'his.amountPaid': 'পরিশোধিত পরিমাণ',
  ...
  'login.usernamePlaceholder': 'ইউজারনেম',
...
const en: Dict = {
  ...
  'user.role': 'Role',
  'user.nameRequired': 'Name and username are required',
